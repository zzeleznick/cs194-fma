...
| !/cs194-fma/images/output/out_cathedral.jpg(Cathedral)!:http://zzeleznick.github.io/cs194-fma/images/output/out_cathedral.jpg | !/cs194-fma/images/output/out_tobolsk.jpg(Tobolsk)!:http://zzeleznick.github.io/cs194-fma/images/output/out_tobolsk.jpg |
|=. Cathedral (1024, 390) |=. Tobolsk (1024, 396) |
|=. Green =  <2, -2>;  Red =   <6, -3> |=. Green =  <3, -4>;  Red =   <3, -7> |
| !/cs194-fma/images/output/out_nativity.jpg(Nativity)!:http://zzeleznick.github.io/cs194-fma/images/output/out_nativity.jpg | !/cs194-fma/images/output/out_settlers.jpg(Settlers)!:http://zzeleznick.github.io/cs194-fma/images/output/out_settlers.jpg |
|=. Nativity (1024, 395) |=. Settlers (1024, 396) |
|=. Green =  <1, -4>;  Red =   <0, -6> |=. Green = <0, 0>;  Red = <-1, 1>  |
| !/cs194-fma/images/output/out_monastery.jpg(Monastery)!:http://zzeleznick.github.io/cs194-fma/images/output/out_monastery.jpg | !/cs194-fma/images/output/de_out_monastery.jpg(White-Balanced Monastery)!:http://zzeleznick.github.io/cs194-fma/images/output/de_out_monastery.jpg |
...
|\2=. Output Images, Original Sizes, & Displacement Vectors[1] |
| !/cs194-fma/images/output/bridge.jpg(Bridge)!:http://zzeleznick.github.io/cs194-fma/images/output/bridge.jpg | !/cs194-fma/images/output/turkmen.jpg(Turkmen)!:http://zzeleznick.github.io/cs194-fma/images/output/turkmen.jpg |
|=. Bridge (9675, 3742) |=. Turkmen (9627, 3762) |
|=. Green =  <7, -33>;  Red =   <9, -38> |=. Green = <9, -12>;  Red = <19, -16> |
| !/cs194-fma/images/output/harvesters.jpg(Harvesters)!:http://zzeleznick.github.io/cs194-fma/images/output/harvesters.jpg | !/cs194-fma/images/output/icon.jpg(Icon)!:http://zzeleznick.github.io/cs194-fma/images/output/icon.jpg |
|=. Harvesters (9656, 3683) |=. Icon (9656, 3683) |
|=. Green =  <0, 8>;  Red =   <2, 5> |=. Green = <15, -17>;  Red = <17, -28>  |
| !/cs194-fma/images/output/lady.jpg(Lady)!:http://zzeleznick.github.io/cs194-fma/images/output/lady.jpg | !/cs194-fma/images/output/melons.jpg(Melons)!:http://zzeleznick.github.io/cs194-fma/images/output/melons.jpg |
|=. Monastery (9637, 3761) |=. Melons (9724, 3770) |
|=. Green = <0, -6>;  Red = <5, -10> |=. Green = <0, 13>;  Red = <8, 22>   |
| !/cs194-fma/images/output/onion_church.jpg(Onion Church)!:http://zzeleznick.github.io/cs194-fma/images/output/onion_church.jpg | !/cs194-fma/images/output/self_portrait.jpg(Self Portrait)!:http://zzeleznick.github.io/cs194-fma/images/output/self_portrait.jpg |
|=. Onion Church (9646, 3781) |=. Self Portrait (9754, 3810) |
|=. Green = <4, -13>;  Red = <9, -17> |=. Green = <8, 6>;  Red = <13, 9>   |
| !/cs194-fma/images/output/workshop.jpg(Workshop)!:http://zzeleznick.github.io/cs194-fma/images/output/workshop.jpg | !/cs194-fma/images/output/village.jpg(Village)!:http://zzeleznick.github.io/cs194-fma/images/output/village.jpg |
|=. Workshop (9627, 3741) |=. Village (9812, 3819) |
|=. Green = <0, -11>;  Red = <-14, -11> |=. Green = <13, -1>;  Red = <9, 6>   |
| !/cs194-fma/images/output/three_generations.jpg(Three Generations)!:http://zzeleznick.github.io/cs194-fma/images/output/three_generations.jpg | !/cs194-fma/images/output/train.jpg(Self Portrait)!:http://zzeleznick.github.io/cs194-fma/images/output/train.jpg |
|=. Three Generations (9629, 3714) |=. Train (9715, 3741) |
|=. Green = <-1, -3>;  Red = <10, -21> |=. Green = <-5, -18>;  Red = <24, -31>   |
| !/cs194-fma/images/output/emir.jpg(Emir)!:http://zzeleznick.github.io/cs194-fma/images/output/emir.jpg | !/cs194-fma/images/output/emir.jpg(Enhanced Emir)!:http://zzeleznick.github.io/cs194-fma/images/output/gamma_emir.jpg |
