...
|\2=. Output Images, Original Sizes, & Displacement Vectors[1] |
| !/images/output/bridge.jpg(Bridge)!:http://zzeleznick.github.io/cs194-fma/images/output/bridge.jpg | !/images/output/turkmen.jpg(Turkmen)!:http://zzeleznick.github.io/cs194-fma/images/output/turkmen.jpg |
|=. Bridge (9675, 3742) |=. Turkmen (9627, 3762) |
|=. Green =  <7, -33>;  Red =   <9, -38> |=. Green = <9, -12>;  Red = <19, -16> |
| !/images/output/harvesters.jpg(Harvesters)!:http://zzeleznick.github.io/cs194-fma/images/output/harvesters.jpg | !/images/output/icon.jpg(Icon)!:http://zzeleznick.github.io/cs194-fma/images/output/icon.jpg |
|=. Harvesters (9656, 3683) |=. Icon (9656, 3683) |
|=. Green =  <0, 8>;  Red =   <2, 5> |=. Green = <15, -17>;  Red = <17, -28>  |
| !/images/output/lady.jpg(Lady)!:http://zzeleznick.github.io/cs194-fma/images/output/lady.jpg | !/images/output/melons.jpg(Melons)!:http://zzeleznick.github.io/cs194-fma/images/output/melons.jpg |
|=. Monastery (9637, 3761) |=. Melons (9724, 3770) |
|=. Green = <0, -6>;  Red = <5, -10> |=. Green = <0, 13>;  Red = <8, 22>   |
| !/images/output/onion_church.jpg(Onion Church)!:http://zzeleznick.github.io/cs194-fma/images/output/onion_church.jpg | !/images/output/self_portrait.jpg(Self Portrait)!:http://zzeleznick.github.io/cs194-fma/images/output/self_portrait.jpg |
|=. Onion Church (9646, 3781) |=. Self Portrait (9754, 3810) |
|=. Green = <4, -13>;  Red = <9, -17> |=. Green = <8, 6>;  Red = <13, 9>   |
| !/images/output/workshop.jpg(Workshop)!:http://zzeleznick.github.io/cs194-fma/images/output/workshop.jpg | !/images/output/village.jpg(Village)!:http://zzeleznick.github.io/cs194-fma/images/output/village.jpg |
|=. Workshop (9627, 3741) |=. Village (9812, 3819) |
|=. Green = <0, -11>;  Red = <-14, -11> |=. Green = <13, -1>;  Red = <9, 6>   |
| !/images/output/three_generations.jpg(Three Generations)!:http://zzeleznick.github.io/cs194-fma/images/output/three_generations.jpg | !/images/output/train.jpg(Self Portrait)!:http://zzeleznick.github.io/cs194-fma/images/output/train.jpg |
|=. Three Generations (9629, 3714) |=. Train (9715, 3741) |
|=. Green = <-1, -3>;  Red = <10, -21> |=. Green = <-5, -18>;  Red = <24, -31>   |
| !/images/output/emir.jpg(Emir)!:http://zzeleznick.github.io/cs194-fma/images/output/emir.jpg | !/images/output/emir.jpg(Enhanced Emir)!:http://zzeleznick.github.io/cs194-fma/images/output/gamma_emir.jpg |
